...
from .views import CustomTokenObtainPairView, createPost, getFeed, getPosts, getUser, CustomRefreshTokenView, registerUser, isAuthenticated, toggleFollow, toggleLike, searchUsers, logout, UpdateUserDetails
urlpatterns = [
