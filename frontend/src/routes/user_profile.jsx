import {
    Box, Button, Flex, Heading, HStack, Image, Text, VStack,
    Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton,
    ModalBody, Avatar, Spinner, useDisclosure
} from "@chakra-ui/react";
import { useEffect, useState } from "react";
import { getUserProfile, toggleFollow, getUserPosts, getFollowers, getFollowing } from "../api/endpoints";
            ...
            <VStack w="100%" alignItems="start" gap="40px">
                ...
                <HStack gap="20px" alignItems="center">
                    <Box boxSize="150px" border="2px solid" borderColor="gray.300" borderRadius="full" overflow="hidden">
                        <Image boxSize="100%" objectFit="cover" src={userData.profile_image} />
                    </Box>
                    ...
                    <VStack gap="20px">
                        <HStack gap="20px" fontSize="18px">
                            ...
                            >
                                <Text>Followers</Text>
                                <Text fontWeight="bold">{userData.followersCount}</Text>
                            </VStack>
                            ...
                            >
                                <Text>Following</Text>
                                <Text fontWeight="bold">{userData.followingCount}</Text>
                            </VStack>
                        </HStack>
