import { Flex, Heading, VStack, HStack, FormControl, Input, Text, Box, Button, FormLabel, Textarea } from "@chakra-ui/react";
  ...
  const handleSubmit = async (e) => {
    ...
    const handlePost = async () => {
        try {
            ...
            await createPost(description, imageFile);
            setDescription("");
    ...
    <Flex flexDirection={"column"} w={"100%"} h={"100%"} alignItems={"center"} justifyContent={"center"} pt={"50px"} gap={5}>
        ...
        <Button ml={5} size={"lg"} onClick={() => {handleNavigate("/"), handlePost()}} colorScheme={"blue"}>Post</Button>
    </Flex>
    )
}
